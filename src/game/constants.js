...
export const START_CASH_CLEAN = 3000000;
...
export const BUILDINGS = {
  ...
  precursor_lockup: {
    ...
    icon: 'box',
    product: 'meth',
    unlock: { properties: 7, cash: 160000 },
    cost: 1550000,
    minAreaM2: 60,
    maxAreaM2: 700,
    referenceAreaM2: 200,
  ...
  meth_cook: {
    ...
    icon: 'flask',
    handles: ['meth'],
    unlock: { properties: 8, cash: 240000 },
    cost: 2400000,
    minAreaM2: 90,
    maxAreaM2: 900,
    referenceAreaM2: 260,
  ...
  ergot_culture: {
    ...
    icon: 'leaf',
    product: 'acid',
    unlock: { properties: 10, cash: 380000 },
    cost: 2800000,
    minAreaM2: 70,
    maxAreaM2: 600,
    referenceAreaM2: 220,
  ...
  blotter_lab: {
    ...
    icon: 'flask',
    handles: ['acid'],
    unlock: { properties: 11, cash: 460000 },
    cost: 4100000,
    minAreaM2: 80,
    maxAreaM2: 700,
    referenceAreaM2: 240,
  ...
  vet_supply: {
    ...
    icon: 'shop',
    product: 'ket',
    unlock: { properties: 9, cash: 300000 },
    cost: 2200000,
    minAreaM2: 110,
    maxAreaM2: 1200,
    referenceAreaM2: 320,
  ...
  drying_room: {
    ...
    icon: 'flask',
    handles: ['ket'],
    unlock: { properties: 9, cash: 320000 },
    cost: 1850000,
    minAreaM2: 70,
    maxAreaM2: 700,
    referenceAreaM2: 210,
  ...
  safehouse: {
    ...
    icon: 'box',
    unlock: { properties: 5, cash: 60000 },
    cost: 980000,
    minAreaM2: 70,
    maxAreaM2: 600,
    referenceAreaM2: 240,
  ...
  cut_house: {
    ...
    unlock: { properties: 6, cash: 95000 },
    cost: 1250000,
    minAreaM2: 90,
    maxAreaM2: 700,
    referenceAreaM2: 230,
  ...
  chopshop: {
    ...
    icon: 'car',
    unlock: { properties: 7, cash: 140000 },
    cost: 1950000,
    minAreaM2: 260,
    maxAreaM2: 2200,
    referenceAreaM2: 620,
...
export const COURIERS = {
  ...
  runner: {
    ...
    cost: 35000, upkeepPerDay: 400, capacity: 14,
  ...
  jogger: {
    ...
    cost: 90000, upkeepPerDay: 600, capacity: 22,
  ...
  bike: {
    ...
    cost: 90000, upkeepPerDay: 800, capacity: 40,
  ...
  ebike: {
    ...
    cost: 220000, upkeepPerDay: 1400, capacity: 55,
  ...
  scooter: {
    ...
    cost: 190000, upkeepPerDay: 1800, capacity: 65,
  ...
  motorcycle: {
    ...
    cost: 780000, upkeepPerDay: 4000, capacity: 45,
  ...
  hatchback: {
    ...
    cost: 210000, upkeepPerDay: 2200, capacity: 95,
  ...
  sedan: {
    ...
    cost: 340000, upkeepPerDay: 3000, capacity: 140,
  ...
  cab: {
    ...
    cost: 680000, upkeepPerDay: 5500, capacity: 160,
  ...
  suv: {
    ...
    cost: 1150000, upkeepPerDay: 4800, capacity: 300,
  ...
  luxury: {
    ...
    cost: 3200000, upkeepPerDay: 12000, capacity: 180,
  ...
  sportscar: {
    ...
    cost: 2400000, upkeepPerDay: 9500, capacity: 55,
  ...
  minivan: {
    ...
    cost: 560000, upkeepPerDay: 3800, capacity: 260,
  ...
  van: {
    ...
    cost: 920000, upkeepPerDay: 5200, capacity: 480,
  ...
  chiller: {
    ...
    cost: 1600000, upkeepPerDay: 7800, capacity: 420,
  ...
  luton: {
    ...
    cost: 1900000, upkeepPerDay: 8400, capacity: 820,
  ...
  pickup: {
    ...
    cost: 840000, upkeepPerDay: 4400, capacity: 340,
  ...
  boxtruck: {
    ...
    cost: 2100000, upkeepPerDay: 11000, capacity: 1700,
  ...
  flatbed: {
    ...
    cost: 2700000, upkeepPerDay: 11800, capacity: 1250,
  ...
  semi: {
    ...
    cost: 6800000, upkeepPerDay: 19000, capacity: 4200,
  ...
  drone: {
    ...
    cost: 1400000, upkeepPerDay: 1600, capacity: 12,
  ...
  heavylift: {
    ...
    cost: 4600000, upkeepPerDay: 4600, capacity: 70,
