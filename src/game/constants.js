...
export const PRODUCTS = {
  ...
  // --- Seven more, chosen to fill gaps in the curve -------------------------
  // Two below anything that existed (bulk you move by the tonne for pennies),
  // three across the middle, and two niche-but-valuable at the quiet end.
  cigs: {
    id: 'cigs',
    name: 'Counterfeit Cigarettes',
    short: 'CIGS',
    color: '#d8c9a3',
    rawName: 'Loose Leaf',
    packName: 'Sleeves',
    packsPerRaw: 16,
    // The cheapest thing in the game by a distance, and the highest volume.
    // Nobody gets excited about a van full of cigarettes.
    basePrice: 600,
    heatPerPackSold: 0.02,
    demandBase: [1.2, 6.5],
    regionBoost: { gb: 1.8, ie: 1.7, fr: 1.5, pl: 1.4, ru: 1.3 },
  },
  nitrous: {
    id: 'nitrous',
    name: 'Nitrous Oxide',
    ...
    heatPerPackSold: 0.02,
    demandBase: [0.9, 4.8],
    regionBoost: { gb: 2.0, nl: 1.6, es: 1.4 },
  },
  ghb: {
    id: 'ghb',
    name: 'GHB',
    short: 'GHB',
    color: '#a9d6c0',
    rawName: 'Crude Solution',
    packName: 'Bottles',
    packsPerRaw: 9,
    basePrice: 7000,
    heatPerPackSold: 0.3,
    demandBase: [0.15, 1.4],
    regionBoost: { nl: 1.7, gb: 1.4, es: 1.3, au: 1.3 },
    regionPenalty: 0.7,
  },
  lean: {
    id: 'lean',
    ...
    short: 'LEAN',
    color: '#c77fb5',
    rawName: 'Diverted Cases',
    packName: 'Pints',
    packsPerRaw: 7,
    basePrice: 15000,
    heatPerPackSold: 0.24,
    demandBase: [0.25, 2.0],
    regionBoost: { us: 2.0, ca: 1.3 },
    regionPenalty: 0.45,
  },
  wax: {
    id: 'wax',
    ...
    short: 'WAX',
    color: '#e0a83c',
    rawName: 'Trim and Flower',
    packName: 'Grams',
    packsPerRaw: 5,
    // Made from what a grow already produces, worth five times as much by
    // weight — the obvious next step once you have flower spare.
    basePrice: 20000,
    heatPerPackSold: 0.15,
    demandBase: [0.3, 2.2],
    regionBoost: { us: 1.7, ca: 1.5, nl: 1.2 },
  },
  pcp: {
    id: 'pcp',
    name: 'PCP',
  ...
  mescaline: {
    ...
    packName: 'Doses',
    packsPerRaw: 6,
    // Grows for years before it is worth anything. Rare, quiet, and it pays.
    basePrice: 45000,
    heatPerPackSold: 0.06,
    demandBase: [0.04, 0.5],
    regionBoost: { us: 1.4, mx: 1.8, es: 1.2 },
    regionPenalty: 0.6,
  },
...
export const BUILDINGS = {
  ...
  morgue: {
    ...
    hidden: true,
    kind: 'clinic',
    // Named apart from the legitimate `funeral_home` above, which is a real
    // business anybody can buy. This is the licensed back half of one, and it
    // is the only building in the game where the cold room is the point.
    name: 'Mortuary',
    blurb: 'A prep room, a bank of refrigerated drawers, and a licence on the wall. Bodies arriving here are the least remarkable thing on the street — which is the entire point of owning one.',
    icon: 'shop',
  ...
  bottling: {
    ...
    handles: ['pills', 'shine', 'roids', 'lean', 'ghb'],
  ...
  lab: {
    ...
    handles: ['weed', 'shrooms', 'hash', 'dmt', 'spice', 'wax', 'mescaline'],
  ...
  pack_line: {
    ...
    kind: 'processing',
    name: 'Packing Line',
    sizeNames: [[0.8, 'Packing Bench'], [1.6, 'Packing Line'], [Infinity, 'Packing Plant']],
    blurb: 'Sleeves, shrink wrap and a date stamp. Bulk goods do not need chemistry, they need throughput.',
    icon: 'box',
    product: null,
    cost: 71250,
    minAreaM2: 90,
  ...
  leaf_barn: {
    ...
    kind: 'production',
    name: 'Leaf Barn',
    sizeNames: [[0.8, 'Drying Shed'], [1.6, 'Leaf Barn'], [Infinity, 'Tobacco Farm']],
    blurb: 'Grown, dried and rolled into somebody else\u2019s packaging. Pennies a sleeve and it never stops moving.',
    icon: 'leaf',
    product: 'cigs',
    cost: 36250,
    minAreaM2: 200,
  ...
  gas_line: {
    ...
    kind: 'production',
    name: 'Canister Line',
    blurb: 'Bulk gas decanted into canisters. Legal to own, legal to sell, and everybody knows what it is for.',
    icon: 'box',
    product: 'nitrous',
    cost: 47500,
    minAreaM2: 70,
  ...
  solvent_room: {
    ...
    kind: 'production',
    name: 'Solvent Room',
    blurb: 'Two things off a shelf and a very careful hand. Cheap to make and easy to get wrong.',
    icon: 'droplet',
    product: 'ghb',
    unlock: { properties: 5, cash: 3000000 },
    cost: 58750,
    minAreaM2: 40,
    maxAreaM2: 480,
    referenceAreaM2: 150,
  ...
  syrup_run: {
    ...
    kind: 'production',
    name: 'Syrup Run',
    blurb: 'Cases off a wholesaler\u2019s dock that were never going to be counted.',
    icon: 'pill',
    product: 'lean',
    unlock: { properties: 7, cash: 8000000 },
    cost: 131250,
    minAreaM2: 70,
    maxAreaM2: 900,
    referenceAreaM2: 260,
  ...
  pcp_cook: {
    ...
    kind: 'production',
    name: 'PCP Cook',
    blurb: 'A short list of chemicals, a long list of reasons not to. Sells to people who know exactly what they want.',
    icon: 'flask',
    product: 'pcp',
    unlock: { properties: 9, cash: 18000000 },
    cost: 187500,
    minAreaM2: 70,
    maxAreaM2: 800,
    referenceAreaM2: 240,
  ...
  cactus_plot: {
    ...
    kind: 'production',
    name: 'Cactus Plot',
    sizeNames: [[0.8, 'Cactus Beds'], [1.6, 'Cactus Plot'], [Infinity, 'Cactus Ranch']],
    blurb: 'Years in the ground before any of it is worth a thing. Nobody is watching, and that is the point.',
    icon: 'spore',
    product: 'mescaline',
    unlock: { properties: 8, cash: 11000000 },
    cost: 143750,
    minAreaM2: 600,
    maxAreaM2: 40000,
    referenceAreaM2: 2400,
    areaExponent: 0.95,
    upkeepPerDay: 2267,
    slots: 4,
    cycleHours: 30,
    rawPerSlot: 2.6,
    supplyCostPerSlot: 9000,
    baseQuality: 0.74,
    heatPerDay: 0.07,
    capacity: 420,
  },
  ...
  quick_cook: {
    ...
    kind: 'processing',
    name: 'Shake Cook',
    blurb: 'Done in a motel bathroom with a bottle and a prayer. Quick, filthy, and it shows.',
    icon: 'flask',
    product: null,
    cost: 48750,
    minAreaM2: 55,
    ...
    areaExponent: 0.75,
    upkeepPerDay: 1600,
    // The fast, rough route. Negative qualityBonus is the whole point of it.
    handles: ['meth'],
    rawPerHour: 9.0,
    costPerRaw: 700,
    // Rougher, but more of it — what the lost grade buys you.
    yieldBonus: 1.3,
    qualityBonus: -0.2,
    heatPerDay: 1.1,
    capacity: 180,
  ...
  bucket_wash: {
    ...
    kind: 'processing',
    name: 'Bucket Wash',
    blurb: 'Acetone and a bucket instead of a bench. Gets it done and loses you a grade.',
    icon: 'droplet',
    product: null,
    cost: 61250,
    minAreaM2: 50,
  ...
  field_press: {
    ...
    kind: 'processing',
    name: 'Field Press',
    blurb: 'A screen, a plate and body weight. As old as the plant.',
    icon: 'press',
    product: null,
    cost: 27500,
    minAreaM2: 40,
  ...
  shed_dry: {
    ...
    kind: 'processing',
    name: 'Drying Shed',
    blurb: 'Racks, a fan and time. Nothing clever, and it handles anything organic.',
    icon: 'spore',
    product: null,
    cost: 33750,
    minAreaM2: 60,
  ...
  tab_line: {
    ...
    kind: 'processing',
    name: 'Tab Line',
    blurb: 'Sheets cut by hand. Faster than a blotter lab and a good deal rougher.',
    icon: 'note',
    product: null,
    cost: 42500,
    minAreaM2: 40,
  ...
  fill_bench: {
    ...
    kind: 'processing',
    name: 'Filling Bench',
    blurb: 'A bench, a pump and a box of caps. Handles anything that goes in a bottle or a vial.',
    icon: 'pill',
    product: null,
    cost: 46250,
    minAreaM2: 50,
  ...
  bulk_bagger: {
    ...
    kind: 'processing',
    name: 'Bulk Bagger',
    blurb: 'A hopper and a heat sealer. For anything sold by the sack rather than the gram.',
    icon: 'box',
    product: null,
    cost: 38750,
    minAreaM2: 120,
  ...
  street_cut: {
    ...
    kind: 'processing',
    name: 'Street Cut',
    blurb: 'Whipped, bagged and out the door the same night. You lose a lot in the mix.',
    icon: 'press',
    product: null,
    cost: 56250,
    minAreaM2: 45,
    ...
    upkeepPerDay: 1733,
    // The fast, rough route. Negative qualityBonus is the whole point of it.
    handles: ['heroin', 'pcp', 'oxy', 'fentanyl'],
    rawPerHour: 8.0,
    costPerRaw: 1100,
    // Rougher, but more of it — what the lost grade buys you.
    yieldBonus: 1.38,
  ...
  greenhouse: {
    ...
    kind: 'production',
    name: 'Greenhouse',
    blurb: 'Glass, sunlight and acres of it. Cheap by the pound and it never quite matches indoor.',
    icon: 'leaf',
    product: 'weed',
    cost: 86250,
    minAreaM2: 600,
  ...
  mushroom_cave: {
    ...
    kind: 'production',
    name: 'Growing Cave',
    blurb: 'Cold, dark, and exactly what they want. Slow, and the best flush you will get.',
    icon: 'spore',
    product: 'shrooms',
    unlock: { properties: 6, cash: 5000000 },
    cost: 118750,
  ...
  shake_bake: {
    ...
    kind: 'production',
    name: 'Shake and Bake',
    blurb: 'One bottle at a time in the back of a car. Almost free to stand up and it will get you found.',
    icon: 'flask',
    product: 'meth',
    cost: 11250,
    minAreaM2: 11,
  ...
  jungle_lab: {
    ...
    kind: 'production',
    name: 'Jungle Lab',
    blurb: 'Miles from anywhere, which is the only reason it works. Enormous output, enormous risk.',
    icon: 'leaf',
    product: 'coke',
    unlock: { properties: 12, cash: 44000000 },
    cost: 562500,
    minAreaM2: 4000,
    maxAreaM2: 200000,
    referenceAreaM2: 20000,
    areaExponent: 0.95,
    upkeepPerDay: 13333,
    slots: 8,
    cycleHours: 30,
    rawPerSlot: 5.2,
    supplyCostPerSlot: 30000,
    baseQuality: 0.62,
    heatPerDay: 1.5,
    capacity: 1600,
  },
  ...
  barn_still: {
    ...
    kind: 'production',
    name: 'Barn Still',
    blurb: 'A proper run, not a bucket. Cheap sugar in, jars out, all week.',
    icon: 'droplet',
    product: 'shine',
    cost: 68750,
    minAreaM2: 400,
  ...
  // --- Storage and haulage --------------------------------------------------
  // The thinnest part of the game and the one the whole thing turns on: a line
  // that outruns its storage stops, and a fleet with nowhere to park cannot
  // grow. Five tiers so the answer to "I am backing up" is a real choice.
  transit_shed: {
    id: 'transit_shed',
    kind: 'storage',
    name: 'Transit Shed',
    blurb: 'A shed near the work. Holds little, costs almost nothing, and saves a van the long way round.',
    icon: 'box',
    sellsPerHour: 3,
    cost: 13750,
    minAreaM2: 20,
  ...
  lockup_row: {
    ...
    kind: 'storage',
    name: 'Lockup Row',
    blurb: 'A dozen roller doors on a back lane. Nothing in one of them is worth a warrant.',
    icon: 'box',
    sellsPerHour: 2,
    cost: 27500,
    minAreaM2: 60,
    ...
    areaExponent: 1,
    upkeepPerDay: 533,
    // Spread across separate units, so a raid finds a fraction of it.
    heatPerDay: 0.05,
    capacity: 340,
  },
  cold_store: {
    ...
    kind: 'storage',
    name: 'Cold Store',
    blurb: 'Chilled and dark. Organics keep their grade instead of losing it on a shelf.',
    icon: 'droplet',
    sellsPerHour: 4,
    unlock: { properties: 6, cash: 4200000 },
    cost: 93750,
    minAreaM2: 140,
    maxAreaM2: 2400,
    referenceAreaM2: 520,
  ...
  container_yard: {
    ...
    kind: 'storage',
    name: 'Container Yard',
    sizeNames: [[0.8, 'Container Row'], [1.6, 'Container Yard'], [Infinity, 'Container Terminal']],
    blurb: 'Boxes stacked four high on hardstanding. Enormous, cheap per unit, and impossible to be discreet about.',
    icon: 'box',
    sellsPerHour: 5,
    unlock: { properties: 9, cash: 16000000 },
    cost: 175000,
    minAreaM2: 800,
    maxAreaM2: 40000,
    referenceAreaM2: 2600,
  ...
  haulage_yard: {
    ...
    kind: 'depot',
    name: 'Haulage Yard',
    sizeNames: [[0.8, 'Truck Stop'], [1.6, 'Haulage Yard'], [Infinity, 'Freight Terminal']],
    blurb: 'A proper yard with a gate and a fitter. Costs more to keep than a car park and keeps a real fleet on the road.',
    icon: 'car',
    requiresKind: 'parking',
    unlock: { properties: 8, cash: 11000000 },
    cost: 93750,
  ...
  // --- Legitimate trades ----------------------------------------------------
  //
  // Everything above under `front` is a LAUNDRY. Every one of them runs at a
  // loss on purpose, because what you are buying is a set of books that can
  // absorb street cash, and that costs money.
  //
  // These are the other thing, and they were missing: businesses bought to be
  // businesses. They turn a real clean profit every day, they wash little or
  // nothing, and they are the answer to "I have clean money, where does it go
  // that isn't more of the chain". Margins are anchored to what these actually
  // make — a car park and a hoarding are close to pure margin once they exist,
  // a filling station turns a fortune over for a few points of it, and a
  // practice sits in between.
  //
  // `earner: true` is what separates the two in the build list, so a player is
  // never guessing which sort of legal they are buying.
  ...
  billboard: {
    ...
    earner: true,
    name: 'Hoarding',
    sizeNames: [[0.8, 'Poster Site'], [1.8, 'Hoarding'], [Infinity, 'Digital Board']],
    blurb: 'A steel frame, a wall you own, and a media buyer who pays monthly. Almost no running cost, and the cheque never varies.',
    icon: 'shop',
    cost: 55000,
    minAreaM2: 4,
    maxAreaM2: 60,
    ...
    upkeepPerDay: 90,
    revenuePerDay: 620,
    // Advertising is invoiced, never cash. It cannot wash a penny.
    launderPerDay: 0,
    cut: 0,
    // A busy, moneyed street is worth several times a quiet one to an advertiser.
    wealthSensitivity: 1.3,
    heatPerDay: -0.05,
    capacity: 0,
  },
  ...
  atm_route: {
    ...
    earner: true,
    name: 'ATM Route',
    sizeNames: [[0.9, 'Two Machines'], [2, 'ATM Route'], [Infinity, 'ATM Network']],
    blurb: 'Machines in other people\u2019s shops, a surcharge on every withdrawal, and a van that fills them. You need somewhere to count it, not much of one.',
    icon: 'store',
    unlock: { properties: 3, cash: 900000 },
    cost: 42000,
    minAreaM2: 12,
    maxAreaM2: 90,
    referenceAreaM2: 30,
    ...
    upkeepPerDay: 120,
    revenuePerDay: 520,
    // Cash in, cash out, all day. It is not much of a business and it is a
    // very good set of books.
    launderPerDay: 180000,
    cut: 0.2,
    wealthSensitivity: 0.5,
    heatPerDay: -0.1,
    capacity: 0,
  ...
  parking_lot: {
    ...
    earner: true,
    name: 'Car Park',
    sizeNames: [[0.7, 'Surface Lot'], [1.8, 'Car Park'], [Infinity, 'Multi-Storey']],
    blurb: 'Tarmac, a barrier and a machine. The cheapest thing there is to run on land you already own, and it takes cash all day.',
    icon: 'car',
    unlock: { properties: 4, cash: 1800000 },
    cost: 210000,
    minAreaM2: 300,
  ...
  vet: {
    ...
    sizeNames: [[0.8, 'Vet Practice'], [1.8, 'Veterinary Clinic'], [Infinity, 'Animal Hospital']],
    blurb: 'Consults, jabs and dentals, paid on the day. People will find money for a dog they would not find for themselves.',
    icon: 'flask',
    unlock: { properties: 4, cash: 2400000 },
    cost: 185000,
    minAreaM2: 120,
    maxAreaM2: 450,
    referenceAreaM2: 220,
  ...
  pharmacy: {
    ...
    earner: true,
    name: 'Pharmacy',
    sizeNames: [[0.8, 'Dispensary'], [1.8, 'Pharmacy'], [Infinity, 'Chemist']],
    blurb: 'Dispensing fees, the counter out front, and a queue that turns up whatever the weather. Boring, regulated, and it never has a bad month.',
    icon: 'shop',
    unlock: { properties: 5, cash: 3200000 },
    cost: 240000,
    minAreaM2: 110,
  ...
  dental: {
    ...
    sizeNames: [[0.8, 'Surgery'], [1.8, 'Dental Practice'], [Infinity, 'Dental Group']],
    blurb: 'Two chairs, a hygienist and a lot of private work. The best margin of any honest thing you can put on a high street.',
    icon: 'flask',
    unlock: { properties: 6, cash: 4500000 },
    cost: 265000,
    minAreaM2: 140,
    maxAreaM2: 520,
    referenceAreaM2: 240,
  ...
  funeral_home: {
    ...
    earner: true,
    name: 'Funeral Home',
    sizeNames: [[0.8, 'Funeral Directors'], [1.8, 'Funeral Home'], [Infinity, 'Funeral Group']],
    blurb: 'Chapel of rest, a hearse, and a trade nobody haggles with. Steady money in any economy, and the only business on the street where a cold room is ordinary.',
    icon: 'shop',
    unlock: { properties: 7, cash: 6500000 },
    cost: 385000,
    minAreaM2: 260,
    maxAreaM2: 1100,
    referenceAreaM2: 480,
  ...
  petrol: {
    ...
    sizeNames: [[0.8, 'Two Pumps'], [1.8, 'Filling Station'], [Infinity, 'Service Station']],
    blurb: 'Pennies a litre on the fuel and a real margin on everything inside the shop. Enormous turnover, and every note of it is cash.',
    icon: 'car',
    unlock: { properties: 8, cash: 9000000 },
    cost: 520000,
    minAreaM2: 400,
    maxAreaM2: 1800,
    referenceAreaM2: 800,
  ...
  waste_haul: {
    ...
    earner: true,
    name: 'Waste Contract',
    sizeNames: [[0.8, 'Skip Hire'], [1.8, 'Waste Contract'], [Infinity, 'Waste Division']],
    blurb: 'Trade bins, skips and a municipal round. Contracts run for years, nobody switches supplier, and there is a reason this trade has always attracted the wrong sort of owner.',
    icon: 'car',
    unlock: { properties: 10, cash: 18000000 },
    cost: 1150000,
    minAreaM2: 900,
    maxAreaM2: 12000,
    referenceAreaM2: 2200,
    areaExponent: 0.95,
    upkeepPerDay: 12500,
    revenuePerDay: 22000,
    launderPerDay: 700000,
    cut: 0.15,
    wealthSensitivity: 0.3,
    heatPerDay: -0.1,
    capacity: 0,
  },
  ...
  rooftop_mast: {
    ...
    earner: true,
    name: 'Rooftop Mast',
    sizeNames: [[0.9, 'Antenna Lease'], [2, 'Rooftop Mast'], [Infinity, 'Mast Site']],
    blurb: 'A network pays you monthly to keep their kit on your roof. You do nothing, ever, and the standing order does not stop.',
    icon: 'shop',
    cost: 38000,
    minAreaM2: 3,
    maxAreaM2: 30,
    ...
    upkeepPerDay: 60,
    revenuePerDay: 420,
    // A lease is a contract with a network operator. There is no cash in it.
    launderPerDay: 0,
    cut: 0,
    // Coverage is worth most where the people and the money already are.
    wealthSensitivity: 1.2,
    heatPerDay: -0.05,
    capacity: 0,
  },
  ...
  driving_school: {
    ...
    earner: true,
    name: 'Driving School',
    sizeNames: [[0.8, 'One Instructor'], [1.8, 'Driving School'], [Infinity, 'Driver Training']],
    blurb: 'Hourly, paid on the day, and the waiting list never shortens. Almost nothing to run beyond the cars.',
    icon: 'car',
    unlock: { properties: 3, cash: 700000 },
    cost: 46000,
    minAreaM2: 20,
    maxAreaM2: 120,
    referenceAreaM2: 50,
  ...
  accountancy: {
    ...
    sizeNames: [[0.8, 'Bookkeepers'], [1.8, 'Accountancy Practice'], [Infinity, 'Accountancy Group']],
    blurb: 'Year-end accounts, payroll and VAT for four hundred small businesses who would rather die than do it themselves. Fees are annual and they renew without being asked.',
    icon: 'shop',
    unlock: { properties: 4, cash: 1600000 },
    cost: 95000,
    minAreaM2: 60,
    maxAreaM2: 260,
    referenceAreaM2: 110,
    ...
    upkeepPerDay: 1250,
    revenuePerDay: 2150,
    // Every penny of it is invoiced and banked. It cannot wash anything, which
    // is precisely the joke about owning one.
    launderPerDay: 0,
    cut: 0,
    wealthSensitivity: 0.9,
    heatPerDay: -0.3,
  ...
  letting_agency: {
    ...
    earner: true,
    name: 'Letting Agency',
    sizeNames: [[0.8, 'Lettings Desk'], [1.8, 'Letting Agency'], [Infinity, 'Property Management']],
    blurb: 'Ten per cent of somebody else\u2019s rent, every month, for answering the phone about a boiler. The oldest quiet money there is.',
    icon: 'store',
    unlock: { properties: 4, cash: 2000000 },
    cost: 120000,
    minAreaM2: 70,
    maxAreaM2: 300,
    referenceAreaM2: 130,
  ...
  physio: {
    ...
    sizeNames: [[0.8, 'Treatment Room'], [1.8, 'Physiotherapy Clinic'], [Infinity, 'Rehab Centre']],
    blurb: 'Six appointments a day per room, paid before they leave, and a course of treatment is never one appointment.',
    icon: 'flask',
    unlock: { properties: 5, cash: 2800000 },
    cost: 155000,
    minAreaM2: 90,
  ...
  daycare: {
    ...
    earner: true,
    name: 'Day Nursery',
    sizeNames: [[0.8, 'Childminders'], [1.8, 'Day Nursery'], [Infinity, 'Nursery Group']],
    blurb: 'Fees monthly in advance, a waiting list two years long, and parents who move house before they move nursery.',
    icon: 'store',
    unlock: { properties: 6, cash: 5000000 },
    cost: 300000,
    minAreaM2: 220,
  ...
  private_clinic: {
    ...
    earner: true,
    name: 'Private Clinic',
    sizeNames: [[0.8, 'Consulting Rooms'], [1.8, 'Private Clinic'], [Infinity, 'Medical Centre']],
    blurb: 'Consultations, minor procedures and a scanner that pays for itself twice a year. People will wait eleven months on a list or pay you on Thursday.',
    icon: 'flask',
    unlock: { properties: 7, cash: 7000000 },
    cost: 340000,
    minAreaM2: 180,
    maxAreaM2: 700,
    referenceAreaM2: 320,
  ...
  crematorium: {
    ...
    earner: true,
    name: 'Crematorium',
    sizeNames: [[0.8, 'Single Chamber'], [1.8, 'Crematorium'], [Infinity, 'Memorial Park']],
    blurb: 'Two retorts, a chapel and a book of remembrance. Enormously expensive to build, cheap to run, and the only real competitor is the next town.',
    icon: 'shop',
    unlock: { properties: 9, cash: 12000000 },
    cost: 620000,
    minAreaM2: 400,
    maxAreaM2: 1600,
    referenceAreaM2: 700,
  ...
  self_store: {
    ...
    earner: true,
    name: 'Self Storage',
    sizeNames: [[0.8, 'Lock-up Row'], [1.8, 'Self Storage'], [Infinity, 'Storage Park']],
    blurb: 'Corrugated boxes let by the month to people who will not throw anything away. Nobody ever leaves, and the only running cost is a light and a gate.',
    icon: 'store',
    unlock: { properties: 9, cash: 14000000 },
    cost: 780000,
    minAreaM2: 700,
    maxAreaM2: 9000,
    referenceAreaM2: 1800,
  ...
  plant_hire: {
    ...
    earner: true,
    name: 'Plant Hire',
    sizeNames: [[0.8, 'Tool Hire'], [1.8, 'Plant Hire'], [Infinity, 'Plant Division']],
    blurb: 'Diggers, dumpers and scaffold, out by the week to every site in the city. The machine is paid off in a season and hires for another fifteen years.',
    icon: 'wrench',
    unlock: { properties: 10, cash: 16000000 },
    cost: 900000,
    minAreaM2: 800,
    maxAreaM2: 12000,
    referenceAreaM2: 2000,
    areaExponent: 0.95,
    upkeepPerDay: 9800,
    revenuePerDay: 17500,
    launderPerDay: 420000,
  ...
  care_home: {
    ...
    earner: true,
    name: 'Care Home',
    sizeNames: [[0.8, 'Residential Home'], [1.8, 'Care Home'], [Infinity, 'Care Group']],
    blurb: 'Sixty beds, occupancy that never drops, and fees that go up every April. The single most dependable cheque in this list and the one that takes the most to run.',
    icon: 'store',
    unlock: { properties: 12, cash: 26000000 },
    cost: 1600000,
    minAreaM2: 900,
    maxAreaM2: 5000,
    referenceAreaM2: 1600,
