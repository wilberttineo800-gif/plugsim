...
const security = (cost, name, blurb) => ({
  ...
  effects: { raidResist: 0.45, upkeepAdd: 4000 },
});
const quiet = (cost, name, blurb) => ({
  id: 'quiet', name, cost, blurb,
  effects: { heatMult: 0.55, upkeepAdd: 5500 },
});
...
const legitSet = (label, refitCost, bookCost) => [
  ...
  },
  {
    ...
    effects: { heatMult: 0.6, revenueMult: 1.1, upkeepAdd: 6000 },
  },
